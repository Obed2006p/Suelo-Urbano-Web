        ...
        try {
            ...
            const schema = {
                ...
                properties: {
                    ...
                    recomendacionEmulsion: { type: Type.STRING, description: "Cómo la emulsión 'Alimento para plantas' beneficia a esta planta." }
                },
            };

            const response: GenerateContentResponse = await ai.models.generateContent({
                model: 'gemini-2.5-flash',
                contents: { parts: [imagePart, { text: "Identifica la planta en la imagen. Proporciona su nombre, cuidados básicos y una recomendación para usar la emulsión 'Alimento para plantas' con ella." }] },
                config: {
                        ...
                        {result && (
                            <div className="animate-fade-in-up w-full text-left">
                                ...
                                <div className="bg-green-200/50 border border-green-300 p-4 rounded-lg dark:bg-green-900/40 dark:border-green-700">
                                    <h4 className="font-semibold text-green-900 flex items-center gap-2 mb-2 dark:text-green-200"><LeafIcon className="h-5 w-5"/>Recomendación Alimento para plantas:</h4>
