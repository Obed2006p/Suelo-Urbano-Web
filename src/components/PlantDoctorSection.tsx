        ...
        try {
            ...
            const briefSchema = {
                ...
                properties: {
                    ...
                    fertilizanteSugerido: { type: Type.STRING, description: "Nombre del fertilizante más adecuado (ej: 'Triple 17', 'Humus de lombriz', 'Emulsión Alimento para plantas')." },
        ...
        try {
            ...
            const detailedSchema = {
                ...
                properties: {
                    ...
                    recomendacionEmulsionDetallada: { type: Type.STRING, description: "Explica en detalle cómo la emulsión 'Alimento para plantas' beneficia a esta planta a largo plazo." },
...
- **recomendacionEmulsionDetallada**: Explica en un párrafo cómo la emulsión 'Alimento para plantas' ayuda específicamente a esta planta y su problema.
