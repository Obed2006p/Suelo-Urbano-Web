...
import { MenuIcon, XIcon, SproutIcon, AtomIcon, WaterDropIcon, HeartbeatIcon, HomeIcon, PlayCircleIcon, HeartIcon, CalendarIcon, FlowerIcon, LockIcon, LeafIcon } from './icons/Icons';
...
const Header: React.FC<HeaderProps> = ({ onNavigate, isHomePage, isPremiumUnlocked = false, onLockStatusChange }) => {
  ...
  const pageNavLinks = [
    ...
    { id: 'nav-link-orquideas', href: '#/orquideas', label: 'Orquídeas', icon: <FlowerIcon className="h-6 w-6 text-white" /> },
  ];
